...
export declare class HTTPApi extends TypedEmitter<HTTPApiEvents> {
    ...
    private headers;
    private apiVerifyCode;
    private apiTrustDevice;
    private apiGetStations;
    private apiGetDevices;
    private apiPushCheck;
    private apiRegisterPushToken;
    private apiSetParameters;
    private apiGetCiphers;
    private apiEventGetAllVideoRecord;
    private apiEventGetAllAlarmRecord;
    private apiEventGetAllHistoryRecord;
    private apiGetInvites;
    private apiConfirmInvite;
    private apiGetSensorHistory;
    private apiGetHouseDetail;
    private apiGetHouseList;
    private apiGetHouseInvites;
    private apiConfirmHouseInvite;
    private apiSendHouseInvite;
    private apiAddLocalUser;
    private apiDeleteLocalUser;
    private apiUpdateLocalUser;
    private apiUpdateUserPassword;
    private FIFTEEN_YEARS_IN_MS;
    private constructor();
    ...
    private loginVerifyCode;
    private loginRequestCaptcha;
    login(options?: LoginOptions): Promise<void>;
    makePostRequest(endPoint: string, data: any, forceConnect?: boolean): Promise<ApiResponse | undefined>;
