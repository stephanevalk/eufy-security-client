...
class PushClient extends tiny_typed_emitter_1.TypedEmitter {
    ...
    buildHeartbeatPingRequest(stream_id) {
        ...
        logging_1.rootPushLogger.debug(`Push client - heartbeatPingRequest`, {
            streamId: stream_id,
        ...
        if (errorMessage) {
            throw new error_1.BuildHeartbeatPingRequestError(errorMessage, {
    ...
    buildHeartbeatAckRequest(stream_id, status) {
        ...
        logging_1.rootPushLogger.debug(`Push client - heartbeatAckRequest`, {
            streamId: stream_id,
            status: status,
    ...
    handleParsedMessage(message) {
        ...
        switch (message.tag) {
            ...
            case models_1.MessageTag.LoginResponse:
                logging_1.rootPushLogger.debug("Push client - Login response: GCM -> logged in -> waiting for push messages...", {
