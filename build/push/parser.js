...
class PushClientParser extends tiny_typed_emitter_1.TypedEmitter {
    ...
    getMinBytesNeeded() {
        switch (this.state) {
            ...
            default:
                throw new error_2.MCSProtocolProcessingStateError("Unknown protocol processing state", {
    ...
    buildProtobufFromTag(messageTag) {
        switch (messageTag) {
            ...
            default:
                throw new error_2.MCSProtocolMessageTagError("Unknown protocol message tag", {
